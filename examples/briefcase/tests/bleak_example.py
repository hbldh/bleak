...
def get_coverage_dir() -> Path:
    ...
    if sys.platform == "android":
        ...
        # /storage/emulated/0/Android/data/com.bleak.briefcaseexample.bleak_example/files
...
def main():
    ...
    app = BleakTestbedApp("BleakTestbed", "com.bleak.briefcaseexample.bleak_example")
