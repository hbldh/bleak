...
class CBCentralManager(CBManager):
    ...
    def scanForPeripheralsWithServices_options_(
        self,
        serviceUUIDs: NSArray[CBUUID] | None,
        options: NSDictionary | None,
    ) -> None: ...
    ...
    def delegate(self) -> CBCentralManagerDelegate | None: ...
...
class CBPeripheral(CBPeer):
    ...
    def discoverServices_(self, serviceUUIDs: NSArray[CBUUID] | None) -> None: ...
    ...
    def discoverCharacteristics_forService_(
        self, characteristicUUIDs: NSArray[CBUUID] | None, service: CBService
    ) -> None: ...
...
class CBPeripheralDelegate(Protocol):
    def peripheral_didDiscoverServices_(
        self, peripheral: CBPeripheral, error: NSError | None
    ) -> None: ...
    def peripheral_didDiscoverIncludedServicesForService_error_(
        self, peripheral: CBPeripheral, service: CBService, error: NSError | None
    ) -> None: ...
...
class CBService(CBAttribute):
    ...
    def includedServices(self) -> NSArray[CBService] | None: ...
